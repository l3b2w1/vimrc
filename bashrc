...
alias rr='reset'
# alias sss='sslocal -c tools/jpa-shadowsocks.json > /dev/null 2>&1 &'
...
HISTIMEFORMAT="%d/%m/%y %T"
alias dcwalk='snmpwalk -v2c -c public localhost dunchong-MIB::dunchong'
alias dctrans='snmptranslate -Tp -IR dunchong'
alias dccomp='net-snmp-config --compile-subagent dc dunchong.c'
